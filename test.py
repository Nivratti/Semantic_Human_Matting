'''
# python test.py --model /content/Semantic_Human_Matting/ckpt/fpn_human_matting/model/model_obj.pth
...
def main(args):
    ...
    frame = cv2.imread("/content/Semantic_Human_Matting/color_vis_2.jpg")
    frame_seg = seg_process(args, frame, myModel)
    cv2.imwrite("frame_seg.png", frame_seg)
